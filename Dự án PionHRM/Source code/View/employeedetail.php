...
//Kiểm tra xem đã có thông tin thôi việc chưa
$sqlCheck = "SELECT * FROM Resignation WHERE employee_id = '$id'";
$resignExist = $db->getOne($sqlCheck);
$isResigned = $resignExist ? true : false;
?>
            ...
            <div class="employee-detail">
                ...
                <div class="employee-top">
                    ...
                    <div class="top-actions">
                        <button class="btn-toolbar" onclick="window.location.href='../View/updateemployee.php?id=<?= $emp['employee_id'] ?>'">Chỉnh sửa</button>
                        
                    <?php if ($emp['work_status'] == 'Đang làm việc'): ?>
                        <button class="btn-toolbar"
                            onclick="window.location.href='../View/form_resignation.php?id=<?= $emp['employee_id'] ?>'">
                            Thôi việc
                        </button>

                    <?php elseif ($emp['work_status'] == 'Sắp nghỉ việc'): ?>
                        <button class="btn-toolbar" disabled>
                            Đã thôi việc
                        </button>
                ...
                <div class="employee-card">
                    ...
                    <?php if ($status == 'Pending'): ?>
                        <button class="btn-activate" onclick="window.location.href='../View/activeaccount.php?id=<?= $emp['employee_id'] ?>'">Kích hoạt tài khoản</button>
